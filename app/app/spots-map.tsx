	...
	useEffect(() => {
		(async () => {
			...
			const response = await axios.get(
				`http://192.168.3.34:3000/api/area-spots?lat=${location.coords.latitude}&lng=${location.coords.longitude}&radius=500`
			);
			console.log(response.data as Spot[]);
			...
			setSpots([
				...
				},
				{
					description:
						"有松の「山ヨ」の瓦は、絞商（しぼりしょう）であった山田与吉郎家のもので、彼らが所有していた建物にその印が見られます。この瓦に刻まれた「山ヨ」は、山田与吉郎家がかつてこの建物を所有していた名残を示しています。山田与吉郎家は有松絞りで知られる有名な絞商",
					lat: 35.06723026834543,
					lng: 136.97038256667997,
					name: "瓦に山ヨ",
					spot_id: 3,
				},
				{
					...
					lat: 35.068486640328175,
					lng: 136.96742823585564,
					name: "駒留め",
					spot_id: 4,
				},
				{
					...
					lat: 35.06596471921301,
					lng: 136.97203038510355,
					name: "旧竹谷佐兵衛店",
					spot_id: 5,
				},
				{
					...
					lat: 35.067881252057916,
					lng: 136.96880493707403,
					name: "ガス灯",
					spot_id: 6,
				},
				{
					...
					lat: 35.06601823070259,
					lng: 136.9709361536767,
					name: "竹田庄九郎碑,鈴木金蔵碑",
					spot_id: 8,
				},
				{
					...
					lat: 35.06907054586859,
					lng: 136.96662157817323,
					name: "有松一里塚",
					spot_id: 10,
				},
				{
					...
					lat: 35.0664684082691,
					lng: 136.97123862095177,
					name: "なまこ壁",
					spot_id: 12,
				},
				{
					...
					lat: 35.06820993164237,
					lng: 136.96775504689705,
					name: "岡家住宅&浮世絵",
					spot_id: 7,
				},
				{
					...
					lat: 35.0684855149003,
					lng: 136.96739921513634,
					name: "小塚家住宅",
					spot_id: 9,
				},
				{
					...
					lat: 35.066374001134285,
					lng: 136.97220117736617,
					name: "山車車庫",
					spot_id: 11,
				},
				{
					...
					lat: 35.068965932723906,
					lng: 136.96696220499004,
					name: "祇園寺",
					spot_id: 13,
				},
			]);
